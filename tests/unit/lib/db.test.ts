...
describe('AppDatabase', () => {
  ...
  it('declares version 15 and exposes the v2 sync indexes (Greptile P1 regression test)', async () => {
    ...
    // adds iconCache, v12 adds maps, v13 adds mapPackages, v14 adds
    // portable chunked package storage, and v15 purges legacy archive tokens).
    // If any future change drops or renumbers
