...
describe('credential purge migration', () => {
  it('upgrades v14 to v15, removes every legacy token shape, and preserves all other data', async () => {
  ...
  it('is idempotent when a v15 database is opened again', async () => {
    await seedV14Database();
