...
| PR #287 | Command ceilings should shape validation, not weaken it | already canonical | `pr-cycle/SKILL.md` and `references/timeout-strategy.md` already require bounded shards/polling and prohibit treating execution ceilings as test verdicts. |
